...
public class LaporanPendapatan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        refreshData(true);
        // Minta izin
        ModulExcel.askForPermission(Manifest.permission.WRITE_EXTERNAL_STORAGE, 0, LaporanPendapatan.this,
                LaporanPendapatan.this);
        ...
        bind.btnExcel.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    ...
                    Toast.makeText(LaporanPendapatan.this, "Terjadi kesalahan harap coba lagi", Toast.LENGTH_SHORT)
                            .show();
                }
            }
        });
