...
public class RekapKategori extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        // Minta izin
        ModulExcel.askForPermission(Manifest.permission.WRITE_EXTERNAL_STORAGE, 0, RekapKategori.this,
                RekapKategori.this);
    ...
    public void refreshData(boolean fetch) {
        ...
        // kategoriRepository.getRekapKategori(137).observe(this, new
        // Observer<List<ViewModelRekapKategori>>() {
        // @Override
        ...
        if (true) {
            Call<RekapKategoriResp> rekapKategoriRespCall = Api.RekapKategori(RekapKategori.this)
                    .getRekapKategori(cari);
