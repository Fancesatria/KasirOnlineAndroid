...
public class RekapPelanggan extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        // Minta izin
        ModulExcel.askForPermission(Manifest.permission.WRITE_EXTERNAL_STORAGE, 0, RekapPelanggan.this,
                RekapPelanggan.this);
    ...
    public void refreshData(boolean fetch) {
        ...
        if (true) {
            Call<RekapPelangganResp> rekapPelangganRespCall = Api.RekapPelanggan(RekapPelanggan.this)
                    .getRekapPelanggan(cari);
